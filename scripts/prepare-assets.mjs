...
const requiredAssets = [
  ...
  ['assets-items/grass/dark.jpg', 'environment/grass-dark.jpg'],
  ...
  ['assets-items/interactive-objects/well.png', 'props/well.png'],
  ['assets-items/calamba-item-assets/land-boundary-marker.png', 'props/land-boundary-marker.png'],
];
